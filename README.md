# [💻 LiveTerm - build terminal styled websites in minutes!](https://michalklimas.com)
...
- [personal website](https://michalklimas.com)
- browser startpage
- project page
...
```bash
sh -c "$(curl -fsSL https://github.com/MichalPPK/WeeTerm/main/install/install.sh)"
```
...
```bash
git clone https://github.com/MichalPPK/WeeTerm.git && cd LiveTerm
```
...
```javascript
{
  ...
  "email": // your email
  "ps1_hostname": "weeerm" // hostname in prompt
