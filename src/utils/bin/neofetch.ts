...
const themeblue = `#0883ff`;
const themecyan = `#08ff83`;
const themered = `#ff0883`;
...
const getInfo = () => {
  ...
  message += `<span style="color: ${mainColor}">Shell</span>: WeeTerm\n`;
  ...
  message += `<span style="color: ${mainColor}">Donate</span>: ${packageJson.btcad}\n`;
